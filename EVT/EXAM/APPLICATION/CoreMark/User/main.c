...
/* Note: 
 * a.If the actual application must require the use of the system with a frequency greater than 120M 
 * b.This routine under 168M（12M_HSE） system conditions_only applied to CH32V20x_D6
 * c.168M is only suitable for Commercial Grade Electronic applications: 0℃ ≤ TA ≤ 70℃ with good heat dissipation
 */
