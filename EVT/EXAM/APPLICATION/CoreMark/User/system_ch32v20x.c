 ...
 *                      For HSE = 8Mhz (CH32V20x_D6)
 *                      For HSE = 12Mhz (CH32V20x_D6 for 168M)
*********************************************************************************
...
/*168M Only suitable for commercial-grade applications,The crystal oscillator selecte 12M
 *-10 < temperature < 70 and good heat dissipation
 *168M(12M_HSE) system conditions_only applied to CH32V20x_D6*/

 #if defined(HSE_VALUE_12M) && defined(CH32V20x_D6)
#define SYSCLK_FREQ_168MHz_HSE  168000000
#endif

#ifndef HSE_VALUE_12M
...
#elif defined SYSCLK_FREQ_168MHz_HSE
uint32_t SystemCoreClock         = SYSCLK_FREQ_168MHz_HSE;        /* System Clock Frequency (Core Clock) */
#else
...
#elif defined SYSCLK_FREQ_168MHz_HSE
static void SetSysClockTo168_HSE( void );
...
static void SetSysClockTo168_HSE(void)
{
  ...
  if (HSEStatus == (uint32_t)0x01)
  {
    ...
    RCC->CFGR0 |= (uint32_t)(RCC_PLLSRC_HSE | RCC_PLLXTPRE_HSE | RCC_PLLMULL14);
