/********************************** (C) COPYRIGHT *******************************
 * File Name          : M2_PID_Parameter_Initl.c
 * Author             : WCH
 * Version            : V1.0.0
 * Date               : 2026/04/23
...
_iq24 Magnitude_table[256] = MAG100_LIMIT_TABLE;
#elif  defined MAG098_TABLE_USED
_iq24 Magnitude_table[256] = MAG098_LIMIT_TABLE;
#elif  defined MAG096_TABLE_USED
_iq24 Magnitude_table[256] = MAG096_LIMIT_TABLE;
#elif  defined MAG094_TABLE_USED
_iq24 Magnitude_table[256] = MAG094_LIMIT_TABLE;
#elif  defined MAG092_TABLE_USED
_iq24 Magnitude_table[256] = MAG092_LIMIT_TABLE;
#elif  defined MAG090_TABLE_USED
_iq24 Magnitude_table[256] = MAG090_LIMIT_TABLE;
#elif  defined MAG088_TABLE_USED
_iq24 Magnitude_table[256] = MAG088_LIMIT_TABLE;
#elif  defined MAG086_TABLE_USED
_iq24 Magnitude_table[256] = MAG086_LIMIT_TABLE;
#endif

/******************************************************************************
* Function Name  : PID_Prameter_Define
* Description    : Speed regulator and current regulator machine parameter definition
* Input          : Pointer to motor PID controller structure
* Output         : None
* Return         : None
******************************************************************************/
...
/******************************************************************************
* Function Name  : PID_Output_Init
* Description    : Speed regulator, current regulator output state initialization.
* Input          : Pointer to motor PID controller structure
* Output         : None
* Return         : None
******************************************************************************/
void PID_Output_Init(Motor_PID_Type * Mpid)
{
    ...
    Mpid->Speed.Propotion = 0;
    Mpid->Speed.Integer = 0;
...
/******************************************************************************
* Function Name  : DCurrProcess_Parameter_Define
* Description    : Definition of parameters related to d-axis current processing
* Input          : d-axis current processing structure
* Output         : None
* Return         : None
******************************************************************************/
